...
import { SafeAreaView, StyleSheet, View, Text, Dimensions, ScrollView, TextInput, TouchableOpacity } from 'react-native';
...
function CommentPage({ route }) {
    ...
    const getComments = async () => {
        ...
        axios.get(`${LOCAL}/commentapp/comment/${bid}/`, {
    ...
    const writeComment = async () => {
        ...
        axios.post(`${LOCAL}/commentapp/comment/${bid}/`, formData,
            {
                headers: {'Authorization': 'Token ' + token},
        }).then(res => {   
            console.log('comment success')
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.inputContainer}>
                ...
                />
                <TouchableOpacity onPress={() => writeComment()} style={styles.postButton}>
                    <Text style={{ color: '#262444', fontSize: 15, fontFamily: 'KoPub World Dotum Medium' }}>Post</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    )
