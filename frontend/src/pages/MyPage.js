    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.titleBox}>
                ...
                <Text style={styles.infoText}>Dali</Text>
            </View>
            <View style={styles.cardContainer}>
                ...
                <TouchableOpacity 
                    activeOpacity={0.5}
                    onPress={() => {navigation.navigate('ShoppingPage')}}
                >
                    <MyPageCard name="SHOPPING" icon="cart-outline" />
                </TouchableOpacity>
                <TouchableOpacity 
                    activeOpacity={0.5}
                    onPress={() => {navigation.navigate('MyGalleryPage', {
                        name: info.name,
                        email: info.email
                    })}}
                >
                ...
                <TouchableOpacity 
                    activeOpacity={0.5}
                    onPress={() => {navigation.navigate('LikedGalleryPage', {
                        name: info.name,
                        email: info.email
                    })}}
                >
