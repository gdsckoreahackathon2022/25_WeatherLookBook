...
import { SafeAreaView, StyleSheet, ScrollView, Dimensions, View, TextInput, Text, TouchableOpacity, Image } from 'react-native';
    ...
    const renderCards = contents.map((data, index) => {
        return (
            <TouchableOpacity key={index}>
                <Image style={styles.cardImage} source={{uri: `${LOCAL}/media/` + data.image}} />
            </TouchableOpacity>
        )
    })
